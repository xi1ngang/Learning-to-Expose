...
from pi_algo.projects.DRL_AEC.utils import feature_extractor
...
class CameraCaptureEnv:
    ...
    def get_state(self) -> torch.Tensor:
        ...
        state_current, _ = feature_extractor(image_current)

        # image_past1 = self.get_image(self.past1_idx)
        # state_past1, _ = feature_extractor(image_past1)

        # image_past2 = self.get_image(self.past2_idx)
        # state_past2, _ = feature_extractor(image_past2)
    ...
    def calculate_reward(self) -> float:
        ...
        reward = stat_reward + flicker_reward
        return 5 * reward
